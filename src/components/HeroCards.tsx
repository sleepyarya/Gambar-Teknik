...
import { BookOpen, FileText, UploadCloud, ClipboardList } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 w-full max-w-6xl px-4">
        ...
        >
          <div className="mb-4 p-3 rounded-full" style={{ background: 'linear-gradient(135deg, #DBEAFE, #E3F2FD)' }}>
            <BookOpen style={{ color: '#1565C0' }} size={32} />
          </div>
          <div className="text-lg font-semibold mb-2" style={{ color: '#1E293B' }}>Materi</div>
          <div className="text-xs text-center" style={{ color: '#546E7A' }}>Materi belum tersedia</div>
        </div>
        ...
        >
          <div className="mb-4 p-3 rounded-full" style={{ background: 'linear-gradient(135deg, #ECEFF1, #E0F2FE)' }}>
            <FileText style={{ color: '#37474F' }} size={32} />
          </div>
          <div className="text-lg font-semibold mb-2" style={{ color: '#1E293B' }}>Tugas</div>
          <div className="text-xs text-center" style={{ color: '#546E7A' }}>Klik untuk melihat soal tugas</div>
        </a>
        ...
        >
          <div className="mb-4 p-3 rounded-full bg-white/20">
            <UploadCloud style={{ color: '#FFFFFF' }} size={32} />
          </div>
          <div className="text-lg font-semibold mb-2 text-white">Pengumpulan Tugas</div>
          <div className="text-xs text-center text-blue-100">Klik untuk memilih kelas</div>
        </button>
        ...
        >
          <div className="mb-4 p-3 rounded-full" style={{ background: 'linear-gradient(135deg, #E0F2FE, #F0F9FF)' }}>
            <ClipboardList style={{ color: '#1565C0' }} size={32} />
          </div>
          <div className="text-lg font-semibold mb-2" style={{ color: '#1E293B' }}>Evaluasi</div>
          <div className="text-xs text-center" style={{ color: '#546E7A' }}>Evaluasi belum tersedia</div>
        </div>
      </div>
    </section>
  );
